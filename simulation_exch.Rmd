---
title: "R code to re-create a simulation for the exchangeable structure for equal cluster sizes"
output: pdf_document
...
rho <- 0.05    # inter-cluster correlation
R <- (1-rho)*diag(n*T) + rho*matrix(1,nrow=n*T,ncol=n*T)  # exchangeable correlation matrix
...
# Fit the model with the true correlation structure (working exchangeable)
